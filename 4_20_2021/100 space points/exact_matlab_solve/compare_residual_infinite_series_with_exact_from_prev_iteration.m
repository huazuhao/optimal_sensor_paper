...
iteration_step_low_rank_smith = 150; %Number of iterations in the low rank smith method for computing the observability gramian
projection_rank_cut_off = n+2; %Set the dimensionality of the subspace spanned by the observability gramian
regularization = 1e-6; %regularization for the eigenvalues from the previous iteration
