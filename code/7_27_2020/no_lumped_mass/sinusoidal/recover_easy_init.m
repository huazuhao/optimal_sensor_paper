...
%selection
saved_matrix = matfile('exact_method_5_choose_5.mat');
...
state.Mobs = Mobs;
gtol = 1e-12;
U_init_recover_low_rank_access = newton_method(gtol, state);


algorithm_projected = projection_matrix*U_init_recover_low_rank_access;
...
figure,
plot(U_init_recover_low_rank_access,'g','LineWidth',3);
hold on;
