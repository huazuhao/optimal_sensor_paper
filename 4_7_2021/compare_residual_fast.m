...
% Problem parameters
n     = 150;  % Number of interior spatial dofs
N     = 150;  % Number of temporal dofs
...
projection_rank_cut_off = 14; %Set the dimensionality of the subspace spanned by the observability gramian
...
for iteration_index = 1:10
    ...
    for index = 1:n+2
        if next_potential_placement(index) ~= 0
            ...
            log_det_objective(index) = objective_det_sigma+log_det_obj; %i can ignore det(sigma_pre_top) because they are the same
